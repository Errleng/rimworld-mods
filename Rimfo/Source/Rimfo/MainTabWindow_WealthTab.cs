    ...
    internal class MainTabWindow_WealthTab : MainTabWindow
    {
        ...
        private void DrawItemWealth(Rect rowRect)
        {
            ...
            foreach (var record in sortedItemWealths)
            {
                ...
                Widgets.Label(labelRect, "Rimfo_WealthTab_ItemRow".Translate(item.LabelCapNoCount, record.count, item.MarketValue, record.totalWealth));
        ...
        private void DrawBuildingWealth(Rect rowRect)
        {
            ...
            foreach (var record in sortedBuildingWealths)
            {
                ...
                Widgets.Label(labelRect, "Rimfo_WealthTab_ItemRow".Translate(building.LabelCapNoCount, record.count, building.GetStatValue(StatDefOf.MarketValueIgnoreHp), record.totalWealth));
                labelRect.y += LABEL_HEIGHT;
                currHeight += LABEL_HEIGHT;
            }
        ...
        private void DrawFloorWealth(Rect rowRect)
        {
            ...
            foreach (var floorWealth in sortedFloorWealths)
            {
                ...
                Widgets.Label(labelRect, "Rimfo_WealthTab_ItemRow".Translate(terrain.LabelCap, record.count, record.wealth, record.count * record.wealth));
                labelRect.y += LABEL_HEIGHT;
                currHeight += LABEL_HEIGHT;
            }
        ...
        private void DrawCreatureWealth(Rect rowRect)
        {
            ...
            foreach (var record in sortedCreatureWealths)
            {
                ...
                Widgets.Label(labelRect, "Rimfo_WealthTab_ItemRow".Translate(pawn.LabelCapNoCount, record.count, pawn.MarketValue, record.totalWealth));
                labelRect.y += LABEL_HEIGHT;
                currHeight += LABEL_HEIGHT;
            }
        ...
        public override void DoWindowContents(Rect inRect)
        {
            ...
            if (map != null)
            {
                ...
                Widgets.Label(rowRect, "Rimfo_WealthTab_Title".Translate(wealthWatcher.WealthItems, wealthWatcher.WealthBuildings, wealthWatcher.WealthFloorsOnly, wealthWatcher.WealthPawns, wealthWatcher.WealthTotal));
                rowRect.y += LABEL_HEIGHT;

                if (Widgets.ButtonText(rowRect, "Rimfo_WealthTab_WealthTypeButton".Translate(wealthTypeToDraw)))
                {
