...
namespace RimSpawners
{
    class CompUniversalSpawnerPawn : ThingComp
    {
        private CompProperties_UniversalSpawnerPawn Props
        {
            get
            {
                return (CompProperties_UniversalSpawnerPawn)this.props;
            }
        }
        ...
        public Lord Lord
        {
            get
            {
                return CompUniversalSpawnerPawn.FindLordToJoin(this.parent, this.Props.lordJob, this.Props.shouldJoinParentLord, null);
            }
        }
        ...
        private bool TrySpawnPawn(out Pawn pawn)
        {
            ...
            if (lord == null)
            {
                lord = CompUniversalSpawnerPawn.CreateNewLord(this.parent, this.aggressive, this.Props.defendRadius, this.Props.lordJob);
            }
            lord.AddPawn(pawn);
